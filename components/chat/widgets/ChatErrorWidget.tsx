...
export default function ChatErrorWidget({ error }: Readonly<ChatErrorWidgetProps>) {
    const colors = useColors();

    return <View className="flex flex-row items-center justify-center gap-4 p-4">
        ...
        <ShieldX size={24} className="w-6 h-6" color={colors.red}/>
